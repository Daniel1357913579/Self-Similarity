...
for r in range(-2,.5,.01):   #iterates along the real values; -2, .5 range due to reference: sci-pi.org.uk/mandel/mandel_vs_log.html 
    for i in range(-2, 2, .01): #iterates along the imaginary values
        ...
        oZr = r #original Z real component starts at real value r
        oZi = i #original Z imaginary component starts at imaginary value i
        ...
        for N in range(100000): #iterates current Z imaginary and real components according to Znew = Zcurr**2+Zorig
            cZr_new = cZr*cZr-cZi*cZi+oZr #placeholder holds iterated real Z component from equation Znew = Zcurr**2+Zorig
            cZi = cZr*cZi*2+oZi #imaginary Z component from equation Znew = Zcurr**2+Zorig
